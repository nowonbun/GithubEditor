...
public class MainController extends AbstractController {
  ...
  public String list(ModelMap modelmap, HttpSession session, HttpServletRequest req, HttpServletResponse res) {
    ...
    try {
      ...
      long count = postDao.getCountByCategory(category);
  ...
  public String search(ModelMap modelmap, HttpSession session, HttpServletRequest req, HttpServletResponse res) {
    ...
    try {
      ...
      String title = query;
      long count = postDao.getCountByTitleLike(query);
  ...
  public String templateDetail(ModelMap modelmap, HttpSession session, HttpServletRequest req, HttpServletResponse res) {
  ...
  public String templateModify(ModelMap modelmap, HttpSession session, HttpServletRequest req, HttpServletResponse res) {
